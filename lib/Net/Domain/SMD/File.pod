...
=item $obj-E<gt>B<fromDateTime>()

The value of L<from()|Net::Domain::SMD::File/"File header access"> converted into an DateTime object.

=item $obj-E<gt>B<fromTime>()

The value of L<from()|Net::Domain::SMD::File/"File header access"> converted into seconds from epoch.
...
=item $obj-E<gt>B<untilDateTime>()

The value of L<until()|Net::Domain::SMD::File/"File header access"> converted into an DateTime object.
...
This module is part of Net-Domain-TMCH distribution version 0.13,
